...
const BannerLanding = () => {
    return (
        <div className=" mb-10 mt-10 ml-5 mr-5">
            ...
            <div>
                <img className=" w-[500px]  h-[480px]  rounded-xl " src="https://img.freepik.com/premium-photo/grilled-chicken-breast-with-steamed-rice-fresh-salad-dark-slate-plate-healthy-meal_1321417-6074.jpg?w=740" alt="" />
            </div>

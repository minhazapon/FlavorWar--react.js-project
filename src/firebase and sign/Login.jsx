...
const Login = () => {
    ...
    return (
        ...
        <div className=" flex justify-center ">
                <div className="  animate__animated   animate__flip animate__repeat-2      w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gradient-to-r from-cyan-300 to-blue-800 text-gray-100">
        <div  className=" flex items-center gap-5">
         <img className=" bg-white p-2 rounded-md h-[50px]" src="https://cdn-icons-png.flaticon.com/128/763/763812.png" alt="" />   
